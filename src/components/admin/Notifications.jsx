    ...
    return (
        <div className="relative inline-flex ml-3">
            ...
            >
                ...
                <div className={`absolute top-0 right-0 w-2.5 h-2.5 border-2 border-white rounded-full ${notificationList.length !== 0 && read ? 'bg-rose-500' : 'bg-green-500'}`}></div>
            </button>

            <Transition
                className="origin-top-right z-10 absolute top-full right-0 -mr-48 sm:mr-0 w-80 h-96 overflow-y-auto min-w-80 bg-white border border-slate-200 py-1.5 rounded shadow-lg overflow-hidden mt-1"
                show={dropdownOpen}
            ...
            >
                ...
                >
                <div className="text-xs font-semibold text-slate-400 uppercase pt-1.5 pb-2 px-4">Notificaciones</div>
                    <ul>
